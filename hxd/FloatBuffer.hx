...
private typedef InnerData = #if flash flash.Vector<Float> #elseif js Float32Expand #elseif lime LimeFloat32Expand #else Array<hxd.impl.Float32> #end
...
#if lime
private abstract LimeFloat32Expand({ pos : Int, array : lime.utils.Float32Array }) {
